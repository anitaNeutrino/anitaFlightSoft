...
#define BAUDS           19     /* number of baud rates supported */
...
{
    byte *base_addr;            /* pointer to base address of IOS module */
...
*/
    ...
    void handshake();
    void psts520();             /* routine calls the Read I.D. Command */
    void rsts520();             /* routine to read I.D. information */
