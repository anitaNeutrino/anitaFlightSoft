...
char *brs[]  = { "50", "75", "150", "300", "600", "1200", "2400", "3600", "4800", "7200", "9600",
		     "14400", "19200", "28800", "38400", "57600", "76800", "153600", "230400", "921600"};
...
*/
    ...
    i_source.bInitialized = FALSE;/* indicate not ready to talk to IP */
...
*/
	...
	case 2: /* set board address command */
		...
		printf("address: %lX\n",addr);
		  ...
		  /* Place IO structure address in interrupt source data structure */
...
{+D}
    ...
    MODULE NAME:    psts521 - print board information
...
*/
   ...
   while(1)
   {
     ...
     switch(choice)
     {
	  ...
	  printf("9 =  7200 baud  19 = 921600 baud\n");
