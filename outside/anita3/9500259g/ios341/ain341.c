...
{+D}
    ...
    ABSTRACT:		   This acquires the auto-zero or the calibration input
                       for the board.
    CALLING
	SEQUENCE:	   calibrate341(ptr,mode);
			    where:
...
*/
    ...
    struct cblk341 temp_blk;
    struct cblk341 *t_blk;
    double f_cor[16];
    sint i, temp_data;
    sint f_samples[16];
...
*/
    ...
    cnfg341(t_blk);				/* generate control register value */
...
*/
    ...
    cnfg341(c_blk); /* configure the board */
