...
/*
{+D}
    SYSTEM:         Acromag IP570 I/O Board
...
/*
    Defined below is the memory map template for the IP570 Board.
...
void isr_57x(void* pData);	/* interrupt handler for IP57x */
