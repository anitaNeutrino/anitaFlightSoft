...
{+D}
    ...
    ABSTRACT:       This module is the main routine for the example program
                    which demonstrates how the IP570 Library is used.
...
*/  
        ...
        do 
		{
          if(flag == 0)
		  {
            ...
            SetMemoryAddress( c_block570[0].nHandle, (long)addr2);	/* Set IP Memory Address */
		  }
...
*/
                  if(GetIpackAddress(c_block570[0].nHandle, c_block570[0].slotLetter, &addr) != S_OK)
                  {
...
/*
    ...
    and initialize the IPACK's data structure with the returned address
*/
                  if(GetIpackMemoryAddress(c_block570[0].nHandle, c_block570[0].slotLetter, &addr2) != S_OK)
                  {
                  ...
                  else
                  {
                     ...
                     ReadIpackID(c_block570[0].nHandle, c_block570[0].slotLetter,
        ...
        case 7: /* board id PROM */
              ...
              {
                /* read board id information */
                ReadIpackID(c_block570[ch_number].nHandle, c_block570[ch_number].slotLetter,
                ...
                printf("\nIP Model Number:             %X",(byte)(c_block570[ch_number].idProm[5]));
