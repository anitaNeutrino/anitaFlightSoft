...
*/
    ...
    struct cblk220 c_block;    /* configuration block */
...
*/
				...
				{	
			                c_block.brd_ptr = (struct map220 *)addr;
	...
	break;
        ...
        case 7: /* Read Calibration Coefficients and I.D. */
	      ...
	      readstat220(&c_block);	/* read and display status */
...
gloop1:
		...
		wro220(&c_block, channel, (ideal_data[channel] << 4));
	    }
            break;
...
gloop2:
		...
		cd220(&c_block, channel);	/* correct data */
		...
		wro220(&c_block, channel, (cor_data[channel] << 4));
	    }
            break;
