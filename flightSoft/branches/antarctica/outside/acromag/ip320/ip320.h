...
#define SA_SIZE 40   /* scan array size , changed by JJB for SEI mode */
/* #define SA_SIZE 20   scan array size , changed by RJN for DIF mode*/
...
struct conf_blk_320
{
    ...
    long *s_cor_buf;	/* corrected buffer start */
...
void ainsc320();/* routine to read analog inputs */
void ainmc320();/* routine to read analog inputs */
void sccd320();	/* routine to correct input data */
void mccd320();	/* routine to correct input data */
void rsts320(); /* read status */
