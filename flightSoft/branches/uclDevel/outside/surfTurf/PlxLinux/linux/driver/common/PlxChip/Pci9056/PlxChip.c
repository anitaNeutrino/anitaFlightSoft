    ...
    )
{
    ...
    switch (IopSpace)
    {
        ...
        case ExpansionRom:
            *pBarIndex        = 6;
            *pOffset_RegRemap = PCI9056_EXP_ROM_REMAP;
            break;
    ...
    )
{
    ...
    {
        if ( (RegisterValue         != PCI9056_PM_CAP_ID) &&
             (RegisterPmCapability  != PCI9056_PM_CAP_ID) &&
             (RegisterHsCapability  != PCI9056_PM_CAP_ID) &&
             (RegisterVpdCapability != PCI9056_PM_CAP_ID) )
        {
            return FALSE;
        }
    }
    ...
    {
        if ( (RegisterValue         != PCI9056_HS_CAP_ID) &&
             (RegisterPmCapability  != PCI9056_HS_CAP_ID) &&
             (RegisterHsCapability  != PCI9056_HS_CAP_ID) &&
             (RegisterVpdCapability != PCI9056_HS_CAP_ID) )
        {
            return FALSE;
        }
    }
    ...
    {
        if ( (RegisterValue         != PCI9056_VPD_CAP_ID) &&
             (RegisterPmCapability  != PCI9056_VPD_CAP_ID) &&
             (RegisterHsCapability  != PCI9056_VPD_CAP_ID) &&
             (RegisterVpdCapability != PCI9056_VPD_CAP_ID) )
        {
            return FALSE;
        }
    }
