                         ...
                         )
{
   ...
   case CONFIG_E_NESTING :
      string = "Nested sections not supported" ;
      break ;
   case CONFIG_E_EOF :
      string = "End of file during parsing" ;
      break ;
   case CONFIG_E_SYSTEM :
      string = "Error during system call" ;
      break ;
   case CONFIG_E_KVP :
      string = "Error during kvpParse" ;
      break ;
   case CONFIG_E_SECTION :
      string = "Requested section not found" ;
      break ;
   case CONFIG_E_UNNAMED :
      string = "Unnamed sections not allowed" ;
      break ;
   default :
