...
*/
   ...
   if((c_blk->param & RESET_INTEN) && (c_blk->enable & RESET))
      output_byte(c_blk->nHandle, &c_blk->brd_ptr->ier, RESET); /* set reset bit */
...
*/
   ...
   if(c_blk->param & VECT )
      output_byte(c_blk->nHandle, &c_blk->brd_ptr->ivr, c_blk->vector);
...
*/
   ...
   if((c_blk->e_mode == 0) && (c_blk->param & MASK))
   {
      ...
      output_byte(c_blk->nHandle, &c_blk->brd_ptr->port[7].b_select, (c_blk->mask_reg & 0x3F));
   }
...
*/
   ...
   {
     output_byte(c_blk->nHandle, &c_blk->brd_ptr->port[7].b_select, 0x07);
     output_byte(c_blk->nHandle, &c_blk->brd_ptr->port[7].b_select, 0x0D);
     output_byte(c_blk->nHandle, &c_blk->brd_ptr->port[7].b_select, 0x06);
     output_byte(c_blk->nHandle, &c_blk->brd_ptr->port[7].b_select, 0x12);
   }
...
*/
     ...
     if(c_blk->param & EVCONTROL)
     {
       ...
       output_byte(c_blk->nHandle, &c_blk->brd_ptr->port[6].b_select, c_blk->ev_control[0]);
     }
...
*/
     ...
     if(c_blk->param & DEBCONTROL)
     {
       ...
       output_byte(c_blk->nHandle, &c_blk->brd_ptr->port[0].b_select, c_blk->deb_control);
     }
...
*/
     ...
     {
       bank_select(BANK2, c_blk);
       output_byte(c_blk->nHandle, &c_blk->brd_ptr->port[1].b_select, c_blk->deb_duration[0]);
       output_byte(c_blk->nHandle, &c_blk->brd_ptr->port[2].b_select, c_blk->deb_duration[1]);
     }
...
*/
     ...
     {
       bank_select(BANK2, c_blk);
       output_byte(c_blk->nHandle, &c_blk->brd_ptr->port[3].b_select, c_blk->deb_clock);
     }
...
*/
     ...
     if((c_blk->param & RESET_INTEN) && (c_blk->enable & INTEN))
     {
       ...
       for(i = 0; i != 6; i++)
       {
         output_byte(c_blk->nHandle, &c_blk->brd_ptr->port[i].b_select, (byte) 0);
         output_byte(c_blk->nHandle, &c_blk->brd_ptr->port[i].b_select, (byte)0xFF);
       }
       output_byte(c_blk->nHandle, &c_blk->brd_ptr->ier, INTEN);
     }
   }
}
...
*/
   ...
   bank_bits = input_byte(c_blk->nHandle, &c_blk->brd_ptr->port[7].b_select); /* get current */
   ...
   output_byte(c_blk->nHandle, &c_blk->brd_ptr->port[7].b_select, bank_bits);
   return(old_bank);
}
