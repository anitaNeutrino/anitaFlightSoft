...
struct map560b                 /* Memory map of board I/O space */
{
    ...
    byte ControlReg0;          /* Control register 0 */
    byte unusedio2;            /* undefined */
    byte ControlReg1;          /* Control register 1 */
    byte unusedio3;            /* undefined */
    byte StatusReg;            /* I/O Status register */
    byte unusedio4;            /* undefined */
    byte IntVectAReg;          /* I/O IntVectA register */
    byte unusedio5;            /* undefined */
    byte IntVectBReg;          /* I/O IntVectB register */
};
...
void isr_560b(void* pData);	/* interrupt handler for IP560 */
