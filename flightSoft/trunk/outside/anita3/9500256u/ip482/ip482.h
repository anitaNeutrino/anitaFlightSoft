...
long rpnt482(struct ip482 *,unsigned port,unsigned point);
long rprt482(struct ip482 *, unsigned port);
long wpnt482(struct ip482 *, unsigned point, unsigned value);
long wprt482(struct ip482 *, unsigned value);

int SetDebounce(struct ip482 *, int counter, BOOL debounce);
int GetDebounce(struct ip482 *, int counter, BOOL *debounce);
void rmid482(struct ip482 *);		/* reads and stores the contents of the id prom */
int BlockingStartCounter482(struct ip482 *, int counter);
