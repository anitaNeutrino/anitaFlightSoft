...
{+D}
    ...
    MODULE NAME:    rsts330 - read status of board
...
{+D}
    ...
    MODULE NAME:    rmid330 - read status of board
    ...
    ABSTRACT:       This module is used to read I.D. of the board.
...
/*
    ...
    This module is used to perform the read status function
    for the board.  The routine will use a pointer
    within the configuration block together with offsets
    to reference the registers on the Board and will transfer the 
