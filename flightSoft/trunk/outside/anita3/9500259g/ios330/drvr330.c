...
*/
    ...
    c_block330.scan_mode = BU_SNGL;	/* scan mode */
    ...
    c_block330.bInitialized = FALSE;/* indicate not ready to talk */
...
*/
    ...
    while(!finished)
    {
      printf("\n\n\nIOS330 Library Demonstration  Rev. A\n\n");
...
*/
				if(GetIOSAddress(c_block330.nHandle, c_block330.slotLetter, &addr) != S_OK)
				{
