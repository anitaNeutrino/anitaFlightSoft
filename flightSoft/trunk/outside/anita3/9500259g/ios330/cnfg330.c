...
{+D}
    ...
    MODULE NAME:    build control - build control word
...
{+D}
    ...
    ABSTRACT:       This writes the channel gain to the board.
...
{+D}
    ...
    ABSTRACT:       This reads the channel gain to the board.
...
{+D}
    ...
    ABSTRACT:	    This configures the board.
