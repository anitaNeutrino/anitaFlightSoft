...
{+D}
    ...
    ABSTRACT:           This routine gets the current IOS clock value.
...
{+D}
    ...
    ABSTRACT:           This routine sets the IOS clock value.
...
int SetIOSClock(c_blk, value )
  struct cblk482 *c_blk;
  BOOL value;
{
	c_blk->m_IOSClock = value;
