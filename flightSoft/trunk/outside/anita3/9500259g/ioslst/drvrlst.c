...
{+D}
  ...
  DATE    BY        PURPOSE
-------  ----   ------------------------------------------------
06/02/10 FJM    Added new model I.D.s 0x50,0x51,0x52,0x53
...
*/
    if(CarrierOpen(0, &c_blocklst.nHandle) != S_OK)
    {
      printf("\nUnable to open ioscarrier.\n");
...
*/      
    ...
    while(!finished)
    {
      printf("\n\nList IOS Modules  Version A\n\n");
      printf(" 1. Exit this Program\n");
      printf(" 2. List IOS Modules\n");
      printf("\nSelect: ");
      scanf("%d",&item);
...
*/  
      ...
      case 2: /* List IOS Modules */
          ...
          if(CarrierInitialize(c_blocklst.nHandle) == S_OK)/* Initialize Carrier */
          {
             ...
             for(c_blocklst.slotLetter = SLOT_A; c_blocklst.slotLetter <= SLOT_D; c_blocklst.slotLetter += 1)
             {
                memset(idProm, 0, sizeof(idProm));		/* clear buffer */
                memset(id_buff, 0, sizeof(id_buff));		/* clear buffer */

                if(GetIOSAddress(c_blocklst.nHandle, c_blocklst.slotLetter, &addr) == S_OK)
                {
                  c_blocklst.brd_ptr = (struct maplst *)addr;
                  c_blocklst.bInitialized = TRUE;

                  /* read from carrier */
                  ReadIOSID(c_blocklst.nHandle, c_blocklst.slotLetter, &idProm[0], (sizeof(idProm) / 2));
        ...
        if( mfg == 0xA3 ) /* one of Acromags */
        {
          switch( ios )
          {
            ...
            case 0x07:
                ...
                return((int)x4);
            case 0x08:
                strcpy((char*)model,"IOS470");
                return((int)x4);
            case 0x09:
                strcpy((char*)model,"IOS445");
                return((int)x4);
            case 0x10:
                strcpy((char*)model,"IOS440-X");
                return((int)x4);
            case 0x11:
                strcpy((char*)model,"IOS330");
                return((int)x4);
            case 0x12:
            ...
            case 0x19:
                ...
                return((int)x4);
            case 0x20:
                strcpy((char*)model,"IOS409");
                return((int)x4);
            case 0x22:
                strcpy((char*)model,"IOS220-16");
                return((int)x4);
            case 0x23:
                strcpy((char*)model,"IOS220-8");
                return((int)x4);
            case 0x24:
                strcpy((char*)model,"IOS520");
                return((int)x4);
            case 0x25:
                strcpy((char*)model,"IOS521");
                return((int)x4);
            case 0x26:
            ...
            case 0x28:
                ...
                return((int)x4);
            case 0x29:
                strcpy((char*)model,"IOS341");
                return((int)x4);
            case 0x32:
                strcpy((char*)model,"IOS320");
                return((int)x4);
            case 0x33:
                strcpy((char*)model,"IOS231-8");
                return((int)x4);
            case 0x34:
                strcpy((char*)model,"IOS231-16");
                return((int)x4);
            case 0x40:
            ...
            case 0x44:
                ...
                return((int)x4);
            case 0x45:
                strcpy((char*)model,"IOS482");
                return((int)x4);
            case 0x46:
                strcpy((char*)model,"IOS483");
                return((int)x4);
            case 0x47:
                strcpy((char*)model,"IOS484");
                return((int)x4);
            case 0x48:
                strcpy((char*)model,"IOSEP20XC"); /* C = configuration mode */
                return((int)x4);
            case 0x49:
                strcpy((char*)model,"IOSEP20XU"); /* U = user mode */
                return((int)x4);
            case 0x50:
                strcpy((char*)model,"IOS560");
                return((int)x4);
            case 0x51:
                strcpy((char*)model,"IOS560-I");
                return((int)x4);
            case 0x52:
                strcpy((char*)model,"IOS571");
                return((int)x4);
            case 0x53:
                strcpy((char*)model,"IOS572");
                return((int)x4);
            case 0xAA:
                strcpy((char*)model,"IOSTEST");   /* factory test module */
                return((int)x4);
            default:
                strcpy((char*)model,"IOGENERIC");
                return((int)x4);
          }
        }
        else
        {
          strcpy((char*)model,"IO_UNKNOWN");
          return((int)x4);
        }
      }
      strcpy((char*)model,"IO_VACANT?");
      return((int)x4);
    }
}
