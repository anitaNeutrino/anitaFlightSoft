...
*/
    ...
    c_block231.bInitialized = FALSE;	/* indicate not ready to talk */
...
*/      
    ...
    while(!finished)
    {
      printf("\nIOS231 Library Demonstration  Rev. A\n");
...
*/
				if(GetIOSAddress(c_block231.nHandle, c_block231.slotLetter, &addr) != S_OK)
				{
