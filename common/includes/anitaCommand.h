...
typedef enum {
    ...
    CMD_TURN_TUFFS_ON = 150,
    CMD_TURN_TUFFS_OFF = 151,
    CMD_TURN_AMPAS_ON = 152,
    CMD_TURN_AMPAS_OFF = 153,
...
typedef enum {
  ...
  ACQD_RATE_SET_DYNAMIC_L2_MASK_OVER=12, //Set over rate and over window
  ACQD_RATE_SET_DYNAMIC_L2_MASK_UNDER=13, //Set under rate and under window
...
typedef enum {
  ...
  PRI_SKIP_BLAST_RATIO_VPOL=18,
  PRI_BLAST_RATIO_MAX=19,
  PRI_STATIC_NOTCH_HIGH_EDGE=20,
  PRI_USE_LONG_DYNAMIC_FILTERING=21,
  PRI_START_DYNAMIC_FREQUENCY=22,
  PRI_STOP_DYNAMIC_FREQUENCY=23,
  PRI_CONSERVATIVE_START=24,
  PRI_THRESH_DB=25
...
typedef enum {
  CALIBD_READOUT_PERIOD = 0,
  CALIBD_TELEM_EVERY = 1,
  CALIBD_TELEM_AVERAGE = 2,
  CALIBD_ADC_AVERAGE = 3,
  CALIBD_CALIBRATION_PERIOD = 4
} CalibdExtraCommand_t;
