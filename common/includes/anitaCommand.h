...
typedef enum {
  ...
  PRI_STATIC_NOTCH_LOW_EDGE=26,
  PRI_STATIC_NOTCH_HIGH_EDGE=27,
  PRI_USE_LONG_DYNAMIC_FILTERING=28,
  PRI_START_DYNAMIC_FREQUENCY=29,
  PRI_STOP_DYNAMIC_FREQUENCY=30,
  PRI_CONSERVATIVE_START=31,
  PRI_THRESH_DB=32
