...
typedef enum {
  ...
  PRI_DISABLE_GPU=19,
  PRI_PRI_CALIB_VERSION=20,
  PRI_PRI_INVERT_TOP_RING_SOFTWARE=21,
  PRI_PRI_DEBUG_MODE=22,
  PRI_SKIP_BLAST_RATIO_VPOL=23,
  PRI_BLAST_RATIO_MAX=24,
  PRI_STATIC_NOTCH_HIGH_EDGE=25,
  PRI_USE_LONG_DYNAMIC_FILTERING=26,
  PRI_START_DYNAMIC_FREQUENCY=27,
  PRI_STOP_DYNAMIC_FREQUENCY=28,
  PRI_CONSERVATIVE_START=29,
  PRI_THRESH_DB=30
